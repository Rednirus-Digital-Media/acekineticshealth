...
if (!class_exists('Medify_header_side_area')) {
	class Medify_header_side_area extends Medify_get_header{
		...
		{
			$page_select = Medify_Theme_Helper::options_compare('side_panel_page_select', 'mb_customize_side_panel', 'custom');
