...
if (!class_exists('Medify_header_mobile')) {
	class Medify_header_mobile extends Medify_get_header{
		...
		public function __construct(){
			$this->header_vars();
	   		...
	   		$header_mobile_background = Medify_Theme_Helper::get_option('mobile_background');
	   		$header_mobile_color = Medify_Theme_Helper::get_option('mobile_color');
	   		$mobile_header_custom =  Medify_Theme_Helper::get_option('mobile_header');
		...
		public function default_header_mobile(){
			$mobile_height = Medify_Theme_Helper::get_option('header_mobile_height');
			$mobile_height_style = '';
				...
				echo "<div class='fullwidth-wrapper'>";
					echo "<div class='wgl-header-row_wrapper'".$mobile_height_style.">";
						...
						echo "<div class='header_side display_grow v_align_middle h_align_right'>";
							echo "<div class='header_area_container'>";
								echo Medify_Theme_Helper::render_html($this->search('mobile', ''));
							echo "</div>";
						echo "</div>";
					echo "</div>";
				echo "</div>";
