<?php
	...
	$single_date =  Medify_Theme_Helper::get_option('single_meta_date');
	...
	$page_title_padding = Medify_Theme_Helper::options_compare('single_padding_layout_3', 'mb_post_layout_conditional', 'custom');
	...
	$apply_animation = Medify_Theme_Helper::options_compare('single_apply_animation', 'mb_post_layout_conditional', 'custom');
