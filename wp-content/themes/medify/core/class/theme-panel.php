    ...
    class Wgl_Theme_Panel{
        ...
        */
        ...
        public function theme_panel_admin_menu(){
            add_menu_page (
                esc_html__('WebGeniusLab', 'medify'),
                esc_html__('WebGeniusLab', 'medify'), 
            ...
            $submenu = array();
            $submenu[] = array(
                esc_html__('Welcome', 'medify'),    //page_title
                esc_html__('Welcome', 'medify'),    //menu_title
                'manage_options',                               //capability
            ...
            if (current_user_can( 'activate_plugins' )):
                $submenu[] = array(
                    esc_html__('Theme Plugins', 'medify'),   //page_title
                    esc_html__('Theme Plugins', 'medify'),   //menu_title
            ...
            $submenu[] = array(
                esc_html__('Requirements', 'medify'),   //page_title
                esc_html__('Requirements', 'medify'),   //menu_title
                'edit_posts',                          //capability
            ...
            $submenu[] = array(
                esc_html__('Activate Theme', 'medify'),   //page_title
                esc_html__('Activate Theme', 'medify'),   //menu_title
                'edit_posts',                           //capability
            ...
            $submenu[] = array(
                esc_html__('Help Center', 'medify'),   //page_title
                esc_html__('Help Center', 'medify'),   //menu_title
                'edit_posts',                           //capability
            ...
            if ( class_exists( 'Medify_Core' ) ) {
                $submenu[] = array(
                    esc_html__('Theme Options', 'medify'),   //page_title
                    esc_html__('Theme Options', 'medify'),   //menu_title
                    'edit_posts',                           //capability
