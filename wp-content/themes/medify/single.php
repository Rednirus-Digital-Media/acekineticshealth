...
$sb = Medify_Theme_Helper::render_sidebars('single');
        ...
        <div class="row<?php echo apply_filters('medify_row_class', $row_class); ?>">
			<div id='main-content' class="wgl_col-<?php echo apply_filters('medify_column_class', $column); ?>">
				...
				if ($nextPost || $previousPost):
					?>
					<div class="medify-post-navigation">
						<?php
				...
				$show_post_related = Medify_Theme_Helper::get_option('single_related_posts');
				...
				if ( (bool)$show_post_related && class_exists('Medify_Core') && class_exists('\Elementor\Plugin')) : ?>
					<?php
					...
					$mb_blog_carousel_r 	  = Medify_Theme_Helper::options_compare('blog_carousel_r', 'mb_blog_show_r', 'custom');
					$mb_blog_title_r 	  	  = Medify_Theme_Helper::options_compare('blog_title_r', 'mb_blog_show_r', 'custom');

					$cats = Medify_Theme_Helper::get_option('blog_cat_r');
					if(!empty($cats)){
					...
					$mb_blog_column_r 	  	  = Medify_Theme_Helper::options_compare('blog_column_r', 'mb_blog_show_r', 'custom');
					$mb_blog_number_r 	      = Medify_Theme_Helper::options_compare('blog_number_r', 'mb_blog_show_r', 'custom');
					...
					<?php
						...
						echo '<div class="medify_module_title"><h3>'.(!empty($mb_blog_title_r) ? esc_html($mb_blog_title_r) : esc_html__('Recent Posts', 'medify')) .' </h3></div>';
						...
						$atts['read_more_hide'] 		= null;
						$atts['read_more_text'] 		= esc_html__('Read More', 'medify');
						$atts['heading_tag'] 			= 'h4';
						$atts['content_letter_count'] 	= 130;
						$atts['crop_square_img'] 		= 1;
						$atts['items_load'] 			= 4;
						$atts['name_load_more'] 		= esc_html__('Load More','medify');
