...
function wgl_extra_user_profile_fields( $user ) { ?>
    <h3><?php esc_html_e("Extra profile information", "medify-core"); ?></h3>

    <table class="form-table">
    <tr>
        <th><label for="instagram"><?php esc_html_e("Instagram", "medify-core"); ?></label></th>
        <td>
            <input type="text" name="instagram" id="instagram" value="<?php echo esc_attr( get_the_author_meta( 'instagram', $user->ID ) ); ?>" class="regular-text" /><br />
            <span class="description"><?php esc_html_e("Please enter your instagram url.", "medify-core"); ?></span>
        </td>
    </tr>
    <tr>
        <th><label for="facebook"><?php esc_html_e("Facebook", "medify-core"); ?></label></th>
        <td>
            <input type="text" name="facebook" id="facebook" value="<?php echo esc_attr( get_the_author_meta( 'facebook', $user->ID ) ); ?>" class="regular-text" /><br />
            <span class="description"><?php esc_html_e("Please enter your facebook url.", "medify-core"); ?></span>
        </td>
    </tr>
    <tr>
    <th><label for="linkedin"><?php esc_html_e("Linkedin", "medify-core"); ?></label></th>
        <td>
            <input type="text" name="linkedin" id="linkedin" value="<?php echo esc_attr( get_the_author_meta( 'linkedin', $user->ID ) ); ?>" class="regular-text" /><br />
            <span class="description"><?php esc_html_e("Please enter your linkedin url.", "medify-core"); ?></span>
        </td>
    </tr>
    <tr>
    <th><label for="twitter"><?php esc_html_e("Twitter", "medify-core"); ?></label></th>
        <td>
            <input type="text" name="twitter" id="twitter" value="<?php echo esc_attr( get_the_author_meta( 'twitter', $user->ID ) ); ?>" class="regular-text" /><br />
            <span class="description"><?php esc_html_e("Please enter your twitter url.", "medify-core"); ?></span>
        </td>
    </tr>
    </table>
<?php }
...
function wgl_custom_fields(){
    if (class_exists('Vc_Manager')) {
        ...
        vc_add_shortcode_param('medify_radio_image', 'medify_radio_image', $gtdu.'/wpb/addon_fields/js/wgl_vc_extenstions.js');
        vc_add_shortcode_param('dropdown_multi','medify_dropdown_field');
        vc_add_shortcode_param('wgl_checkbox', 'medify_checkbox_custom', $gtdu.'/wpb/addon_fields/js/wgl_vc_extenstions.js');
        vc_add_shortcode_param('medify_param_heading', 'medify_heading_line');
    }
}
...
function wgl_wp_head_custom_code() {
    ...
    if (class_exists('Medify_Theme_Helper')) {
        $header_custom_code = Medify_Theme_Helper::get_option('header_custom_js');
    }
...
function wgl_custom_footer_js() {
     if (class_exists('Medify_Theme_Helper')) {
        $custom_js = Medify_Theme_Helper::get_option('custom_js');
    }
