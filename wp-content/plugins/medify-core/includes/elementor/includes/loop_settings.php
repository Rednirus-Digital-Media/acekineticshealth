    ...
    class Wgl_Loop_Settings{
        ...
        public static function init($self, $array = array()){
	        ...
	        $self->start_controls_section(
	            'query_section',
	            array(
	                'label'      => esc_html__('Query', 'medify-core' ),
	        ...
	        $self->add_control(
	            'number_of_posts',
	            array(
	                'label'       => esc_html__('Post count', 'medify-core'),
	        ...
	        $self->add_control(
	            'order_by',
	            array(
	                'label'       => esc_html__('Order by', 'medify-core'),
	                'type'        => Controls_Manager::SELECT,
	                'default'     => 'date',
	                'options'     => array(
	                    'date'            => esc_html__('Date', 'medify-core'),
	                    'title'           => esc_html__('Title', 'medify-core'),
	                    'author'          => esc_html__('Author', 'medify-core'),
	                    'modified'        => esc_html__('Modified', 'medify-core'),
	                    'rand'            => esc_html__('Random', 'medify-core'),
	                    'comment_count'   => esc_html__('Comments', 'medify-core'),
	                    'menu_order'      => esc_html__('Menu Order', 'medify-core'),                    	                    
	                ),
	            )
	        );
	        ...
	        $self->add_control(
	            'order',
	            array(
	                'label'       => esc_html__('Order', 'medify-core'),
	                'type'        => Controls_Manager::SELECT,
	                'default'     => 'DESC',
	                'options'     => array(
	                    'DESC'          => esc_html__('Descending', 'medify-core'),
	                    'ASC'           => esc_html__('Ascending', 'medify-core'),
	                ),
	            )
	        );
            ...
            if(!isset($array['hide_cats'])){            
                ...
                $self->add_control('categories',
                    array(
                        'label'         => esc_html__( 'Filter By Category Slug', 'medify-core' ),
                ...
                $self->add_control(
                    'exclude_categories',
                    array(
                        'label'        => esc_html__('Exclude These Categories','medify-core' ),
                        'type'         => Controls_Manager::SWITCHER,
                        'label_on'     => esc_html__( 'On', 'medify-core' ),
                        'label_off'    => esc_html__( 'Off', 'medify-core' ),
                        'return_value' => 'yes',
                        'description'   => esc_html__('Leave empty for all','medify-core'),
                    )
                );  
            }	        
            ...
            if(!isset($array['hide_tags'])){
                ...
                $self->add_control('tags',
                    array(
                        'label'         => esc_html__( 'Filter By Tags Slug', 'medify-core' ),
                        'type'          => Controls_Manager::SELECT2,
                        'multiple'      => true,
                        'label_block'   => true,
                ...
                $self->add_control(
                    'exclude_tags',
                    array(
                        'label'        => esc_html__('Exclude These Tags','medify-core' ),
                        'type'         => Controls_Manager::SWITCHER,
                        'label_on'     => esc_html__( 'On', 'medify-core' ),
                        'label_off'    => esc_html__( 'Off', 'medify-core' ),
                        'return_value' => 'yes',
            ...
            $self->add_control('taxonomies',
                array(
                    'label'         => esc_html__( 'Taxonomies', 'medify-core' ),
                    'type'          => Controls_Manager::SELECT2,        
                    'multiple'      => true,
                    'label_block'   => true,
            ...
            $self->add_control(
                'exclude_taxonomies',
                array(
                    'label'        => esc_html__('Exclude These Taxonomies','medify-core' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'label_on'     => esc_html__( 'On', 'medify-core' ),
                    'label_off'    => esc_html__( 'Off', 'medify-core' ),
                    'return_value' => 'yes',
                    'description'   => esc_html__('Filter output by custom taxonomies categories, enter category names here.','medify-core'),
                )
            ); 
            ...
            if(!isset($array['hide_individual_posts'])){
                ...
                $self->add_control('by_posts',
                    array(
                        'label'         => esc_html__( 'Individual Posts/Pages/Custom Post Types', 'medify-core' ),
                        'type'          => Controls_Manager::SELECT2,
                        'multiple'      => true,
                        'label_block'   => true,
                ...
                $self->add_control(
                    'exclude_any',
                    array(
                        'label'        => esc_html__('Exclude These Posts/Pages/Custom Post Types','medify-core' ),
                        'type'         => Controls_Manager::SWITCHER,
                        'label_on'     => esc_html__( 'On', 'medify-core' ),
                        'label_off'    => esc_html__( 'Off', 'medify-core' ),
                        'return_value' => 'yes',
                        'description'   => esc_html__('Individual Posts/Pages/Custom Post Types','medify-core'),
                    )
                );  
            }
            ...
            $self->add_control('author',
                array(
                    'label'         => esc_html__( 'Author', 'medify-core' ),
                    'type'          => Controls_Manager::SELECT2,
                    'multiple'      => true,
                    'label_block'   => true,
            ...
            $self->add_control(
                'exclude_author',
                array(
                    'label'        => esc_html__('Exclude Author','medify-core' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'label_on'     => esc_html__( 'On', 'medify-core' ),
                    'label_off'    => esc_html__( 'Off', 'medify-core' ),
                    'return_value' => 'yes',
                    'description'   => esc_html__('Filter by author name','medify-core'),
                )
            );
        ...
        public static function categories_suggester() {
            ...
            foreach ( $categories as $cat ) {
                ...
                $content[(string) $cat->slug] = $cat->cat_name.(!empty($parent) ? esc_html__(' (Parent categories: (', 'medify-core') .$parent.'))' : "");
            }
            return $content;  
        }
        ...
        public static function taxonomies_suggester(){
            ...
            foreach ( $tags as $tag ) {
                ...
                $content[ $tag->taxonomy.":".$tag->slug ] = $tag->name . ' (' . $tag->taxonomy . ')'.(!empty($parent) ? esc_html__(' (Parent categories: (', 'medify-core') .$parent.'))' : "");
