    ...
    class Wgl_Carousel_Settings{
        ...
        public static function options($self, $array = array()){
            ...
            $self->add_control('use_carousel',
                array(
                    'label'        => esc_html__('Use Carousel','medify-core' ),
            ...
            $self->add_control(
                'slides_to_scroll',
                array(
                    'label'        => esc_html__('Slide per single item at a time','medify-core' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'label_on'     => esc_html__( 'On', 'medify-core' ),
                    'label_off'    => esc_html__( 'Off', 'medify-core' ),
                    'return_value' => 'yes',
            ...
            $self->add_control('prev_next_position',
                array(
                    'label'             => esc_html__('Arrows Positioning', 'medify-core'),
                    'type'              => Controls_Manager::SELECT,
                    'options'           => [
                        ''              => esc_html__('Opposite each other', 'medify-core'),
                        'right'         => esc_html__('Bottom right corner', 'medify-core'),
                    ],
                    'condition'         => [
                        'use_prev_next'   => 'yes',
                    ] 
            ...
            $self->add_control('custom_prev_next_color',
                array(
                    'label'        => esc_html__('Customize Arrows Colors','medify-core' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'label_on'     => esc_html__( 'On', 'medify-core' ),
                    'label_off'    => esc_html__( 'Off', 'medify-core' ),
                    'return_value' => 'yes',
            ...
            $self->add_control(
                'prev_next_color',
                array(
                    'label' => esc_html__( 'Arrows Color', 'medify-core' ),
                    'type'  =>  Controls_Manager::COLOR,
            ...
            $self->add_control(
                'prev_next_bg_idle',
                array(
                    'label' => esc_html__( 'Arrows Background Color', 'medify-core' ),
                    'type'  =>  Controls_Manager::COLOR,
                     'condition'         => [
                        'custom_prev_next_color'   => 'yes',
                    ]
            ...
            $self->add_control(
                'prev_next_bg_hover',
                array(
                    'label' => esc_html__( 'Arrows Background', 'medify-core' ),
                    'type'  =>  Controls_Manager::COLOR,
                     'condition'         => [
                        'custom_prev_next_color'   => 'yes',
                    ]
        ...
        public static function init($atts, $item = array(), $templates = false){
            ...
            if ((bool)$custom_pag_color || (bool)$custom_prev_next_color || !empty($pag_offset) || !empty($prev_next_offset)) {
                $carousel_id = uniqid( "medify_carousel_" );
            }
            ...
            ob_start();
                if ( (bool)$custom_prev_next_color ) {
                    ...
                    $bg_color_idle_shadow = '0px 9px 30px 0px rgba('.(!empty($prev_next_bg_idle) ? \Medify_Theme_Helper::hexToRGB($prev_next_bg_idle).',0.4' : '0,0,0,0').')';
                    $bg_color_hover_shadow = '0px 9px 30px 0px rgba('.(!empty($prev_next_bg_hover) ? \Medify_Theme_Helper::hexToRGB($prev_next_bg_hover).',0.4' : '0,0,0,0').')';
