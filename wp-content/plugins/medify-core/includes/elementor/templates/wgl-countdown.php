...
class WglCountDown{
    ...
    public function render( $self, $atts ){
        ...
        $data_array['labels'][]  =  esc_attr( esc_html__( 'Years', 'medify' ) );
        $data_array['labels'][]  =  esc_attr( esc_html__( 'Months', 'medify' ) );
        $data_array['labels'][]  =  esc_attr( esc_html__( 'Weeks', 'medify' ) );
        $data_array['labels'][]  =  esc_attr( esc_html__( 'Days', 'medify' ) );
        $data_array['labels'][]  =  esc_attr( esc_html__( 'Hours', 'medify' ) );
        $data_array['labels'][]  =  esc_attr( esc_html__( 'Minutes', 'medify' ) );
        $data_array['labels'][]  =  esc_attr( esc_html__( 'Seconds', 'medify' ) );
        $data_array['labels1'][] =  esc_attr( esc_html__( 'Year', 'medify' ) );
        $data_array['labels1'][] =  esc_attr( esc_html__( 'Month', 'medify' ) );
        $data_array['labels1'][] =  esc_attr( esc_html__( 'Week', 'medify' ) );
        $data_array['labels1'][] =  esc_attr( esc_html__( 'Day', 'medify' ) );
        $data_array['labels1'][] =  esc_attr( esc_html__( 'Hour', 'medify' ) );
        $data_array['labels1'][] =  esc_attr( esc_html__( 'Minute', 'medify' ) );
        $data_array['labels1'][] =  esc_attr( esc_html__( 'Second', 'medify' ) );
