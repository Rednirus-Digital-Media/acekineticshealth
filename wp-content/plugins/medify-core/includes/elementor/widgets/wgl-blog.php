...
class Wgl_Blog extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Wgl Blog', 'medify-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'custom_blog_mask',
            array(
                'label'        => esc_html__('Add Image Idle Overlay','medify-core' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'On', 'medify-core' ),
                'label_off'    => esc_html__( 'Off', 'medify-core' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            array(
                'label'        => esc_html__('Add Image Hover Overlay','medify-core' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'On', 'medify-core' ),
                'label_off'    => esc_html__( 'Off', 'medify-core' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'custom_blog_bg_item',
            array(
                'label'        => esc_html__('Add Items Background','medify-core' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'On', 'medify-core' ),
                'label_off'    => esc_html__( 'Off', 'medify-core' ),
                'return_value' => 'yes',
