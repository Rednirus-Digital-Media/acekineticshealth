...
class Wgl_Button extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Wgl Button', 'medify-core' );
    }
    ...
    public static function get_button_sizes() {
		return [
			'xs' => esc_html__( 'Extra Small', 'medify-core' ),
			'sm' => esc_html__( 'Small', 'medify-core' ),
			'md' => esc_html__( 'Medium', 'medify-core' ),
			'lg' => esc_html__( 'Large', 'medify-core' ),
			'xl' => esc_html__( 'Extra Large', 'medify-core' ),
		];
	}
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section('wgl_button_section',
            array(
                'label'         => esc_html__('Button Settings', 'medify-core'),
            )
        );
		...
		$this->add_control(
			'text',
			[
				'label' => esc_html__( 'Text', 'medify-core' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				'default' => esc_html__( 'Click here', 'medify-core' ),
				'placeholder' => esc_html__( 'Click here', 'medify-core' ),
			]
		);
		...
		$this->add_control(
			'button_css_id',
			[
				'label' => esc_html__( 'Button ID', 'medify-core' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				'default' => '',
				'title' => esc_html__( 'Add your custom id WITHOUT the Pound key. e.g: my-id', 'medify-core' ),
				'label_block' => false,
				'description' => esc_html__( 'Please make sure the ID is unique and not used elsewhere on the page this form is displayed. This field allows <code>A-z 0-9</code> & underscore chars without spaces.', 'medify-core' ),
				'separator' => 'before',
        ...
        Wgl_Icons::init( $this, array( 'label' => esc_html__('Button ', 'medify-core'), 'output' => $output,'section' => true, 'prefix' => '' ) );
        ...
        $this->add_control(
            'icon_size',
            [
                'label' => esc_html__( 'Icon Font Size', 'medify-core' ),
                'type' => Controls_Manager::SLIDER,
				'separator' => 'before',
                'range' => [
                    'px' => [
    ...
    public static function init_button($self, $settings) {
		...
		<div <?php echo $self->get_render_attribute_string( 'wrapper' ); ?>>
			<a <?php echo $self->get_render_attribute_string( 'button' ); ?>>
			<span <?php echo $self->get_render_attribute_string( 'content-wrapper' ); ?>>
				<?php if ( ! empty( $settings['icon_type'] ) ) :
					...
					echo \Medify_Theme_Helper::render_html($button_icon_out);
				endif; ?>
