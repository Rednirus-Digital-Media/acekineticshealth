...
class Wgl_Image_Comparison extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Wgl Image Comparison', 'medify-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section('wgl_image_comparison_section',
            array(
                'label'         => esc_html__('Image Comparison Settings', 'medify-core'),
            )
        );
        ...
        $this->add_control(
            'before_image',
            array(
                'label'       => esc_html__( 'Before Image', 'medify-core' ),
        ...
        $this->add_control(
            'after_image',
            array(
                'label'       => esc_html__( 'After Image', 'medify-core' ),
                'type'        => Controls_Manager::MEDIA,
                'label_block' => true,
                'default' => [
                    'url' => Utils::get_placeholder_image_src(),
        ...
        $this->start_controls_section(
			'section_style',
			[
				'label' => esc_html__( 'Slider Bar Styles', 'medify-core' ),
        ...
        $this->add_control(
			'slider',
			[
				'label' => esc_html__( 'Slider Bar', 'medify-core' ),
