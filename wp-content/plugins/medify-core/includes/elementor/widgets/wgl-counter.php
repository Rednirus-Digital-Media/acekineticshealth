...
class Wgl_Counter extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Wgl Counter', 'medify-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section('wgl_counter_content',
            array(
                'label'         => esc_html__('Counter Content', 'medify-core'),
            )
        );
        Wgl_Icons::init( $this, array( 'label' => esc_html__('Counter ', 'medify-core'), 'output' => '','section' => false, 'prefix' => '' ) );

        $this->add_control(
            'start_value',
            [
                'label' => esc_html__( 'Start Value', 'medify-core' ),
        ...
        $this->add_control(
            'end_value',
            [
                'label' => esc_html__( 'End Value', 'medify-core' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 1,
                'step' => 10,
                'default' => 120,
        ...
        $this->add_control('prefix',
            array(
                'label'         => esc_html__('Counter Prefix', 'medify-core'),
        ...
        $this->add_control('suffix',
            array(
                'label'         => esc_html__('Counter Suffix', 'medify-core'),
                'type'          => Controls_Manager::TEXT,
                'placeholder'       => esc_html__('+', 'medify-core'),
            )
        );
        ...
        $this->add_responsive_control(
            'value_offset',
            array(
                'label' => esc_html__( 'Value Offset', 'medify-core' ),
                'type' => Controls_Manager::DIMENSIONS,
                'selectors' => [
        ...
        $this->add_control('title_tag',
            array(
                ...
                'default'       => 'h3',
                'description'   => esc_html__( 'Choose your tag for counter title', 'medify-core' ),
                'options'       => [
                    'h1'      => 'H1',
                    'h2'      => 'H2',
                    'h3'      => 'H3',
                ...
                <div class="wgl-counter_content-wrap">
                    <div class="wgl-counter_value-wrap"><?php
                        ...
                        if (!empty($settings['end_value'])) {?>
                            <span <?php echo $this->get_render_attribute_string( 'counter_value' ); ?>><?php echo $settings['start_value'];?></span><?php
                        }
