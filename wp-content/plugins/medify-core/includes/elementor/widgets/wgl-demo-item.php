...
class Wgl_Demo_Item extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Wgl Demo Item', 'medify-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section('wgl_demo_item_section',
            array(
                'label'         => esc_html__('Demo Item Settings', 'medify-core'),
            )
        );
        ...
        $this->add_control('title_tag',
            array(
                ...
                'default'       => 'h3',
                'description'   => esc_html__( 'Choose your tag for demo item title', 'medify-core' ),
                'options'       => [
                    'h1'      => 'H1',
                    'h2'      => 'H2',
                    'h3'      => 'H3',
        ...
        $this->add_control('coming_soon',
            array(
                'label'        => esc_html__('Coming Soon','medify-core' ),
        ...
        $this->add_control('add_button',
            array(
                'label'        => esc_html__('Add Button','medify-core' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'On', 'medify-core' ),
                'label_off'    => esc_html__( 'Off', 'medify-core' ),
                'return_value' => 'yes',
        ...
        $this->add_control('button_title',
            array(
                'label'         => esc_html__('Button Title', 'medify-core'),
                'type'          => Controls_Manager::TEXT,
                'label_block'   => true,
                'default'       => esc_html__('View Demo', 'medify-core'),
                'condition'     => [
                    'add_button'   => 'yes',
                    'coming_soon'   => '',
                ]
        ...
        $this->add_control('demo_link',
            array(
                'label'             => esc_html__('Demo Link', 'medify-core'),
        ...
        $this->start_controls_section(
			'section_style',
			[
				'label' => esc_html__( 'Demo Item Styles', 'medify-core' ),
        ...
        $this->add_control(
            'coming_color',
            array(
                'label' => esc_html__( 'Coming Soon Color', 'medify-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => $third_color,
                'separator' => 'before',
                'selectors' => array(
