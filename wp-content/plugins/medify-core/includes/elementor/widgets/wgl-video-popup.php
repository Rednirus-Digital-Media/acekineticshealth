...
class Wgl_Video_Popup extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Wgl Video Popup', 'medify-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section('wgl_video_popup_section',
            array(
                'label'         => esc_html__('Video Popup Settings', 'medify-core'),
            )
        );
        ...
        $this->add_control(
			'link',
			[
				'label' => esc_html__( 'Video Link', 'medify-core' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				'placeholder' => esc_html__( 'Enter your URL', 'medify-core' ),
				'description' => esc_html__( 'Enter video link from youtube or vimeo.', 'medify-core' ),
        ...
        $this->add_control(
            'title_pos',
            array(
                'label' => esc_html__( 'Title Position', 'medify-core' ),
        ...
        $this->add_responsive_control(
			'button_pos',
			[
				'label' => esc_html__( 'Video Popup Button Alignment', 'medify-core' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left'    => [
						'title' => esc_html__( 'Left', 'medify-core' ),
					...
					'inline' => [
						'title' => esc_html__( 'Inline', 'medify-core' ),
        ...
        $this->add_control(
			'bg_image',
			[
                'label'       => esc_html__( 'Background Image', 'medify-core' ),
                'type'        => Controls_Manager::MEDIA,
                'label_block' => true,
                'description' => esc_html__( 'Select video background image.', 'medify-core'),
                'separator' => 'after',
            ]
        );
        ...
        $this->add_control(
            'animation_style',
            [
                'label'             => esc_html__('Select Animation Style', 'medify-core'),
                'type'              => Controls_Manager::SELECT,
                'options'           => [
                    'circles'       => esc_html__('Pulsing Circles', 'medify-core'),
                    'ring_pulse'    => esc_html__('Pulsing Ring', 'medify-core'),
                    'ring_rotate'   => esc_html__('Rotating Ring', 'medify-core'),
                ],
                'default'           => 'circles',
            ]
        );
        ...
        $this->add_control(
            ...
            array(
                'label'        => esc_html__('Always Run Animation','medify-core' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'On', 'medify-core' ),
                'label_off'    => esc_html__( 'Off', 'medify-core' ),
                'description'  => esc_html__( 'Run until hover state.', 'medify-core' ),
                'return_value' => 'yes',
            )
        );
        ...
        $this->start_controls_section(
			'title_style',
			[
				'label' => esc_html__( 'Title Styles', 'medify-core' ),
        ...
        $this->start_controls_section(
			'button_style',
			[
				'label' => esc_html__( 'Button Styles', 'medify-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
        );
		...
		$this->add_control(
            'button_size',
            [
                'label' => esc_html__( 'Button Size', 'medify-core' ),
                ...
                'description' => esc_html__( 'Enter button diameter in pixels.', 'medify-core' ),
                'selectors' => [
        ...
        $this->add_group_control(
			...
			[
				'name' => 'bg_color',
				'label' => esc_html__( 'Button Background', 'medify-core' ),
		...
		$this->add_control(
            'triangle_size',
            [
                'label' => esc_html__( 'Triangle Size', 'medify-core' ),
                'type' => Controls_Manager::SLIDER,
				'separator' => 'before',
                'range' => [
                    'px' => [
        ...
        $this->add_control(
			'triangle_color',
			[
				'label' => esc_html__( 'Triangle Color', 'medify-core' ),
				'type' => Controls_Manager::COLOR,
                'default' => $header_font_color,
				'selectors' => [
        ...
        $this->add_control(
            'triangle_corners',
            array(
                'label'        => esc_html__('Rounded Corners','medify-core' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'On', 'medify-core' ),
                'label_off'    => esc_html__( 'Off', 'medify-core' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
			'anim_color',
			[
				'label' => esc_html__( 'Animation Circles Color', 'medify-core' ),
				'type' => Controls_Manager::COLOR,
                'default' => $header_font_color,
				'selectors' => [
    ...
    protected function render() {
        ...
        switch ($settings['animation_style']) {
            ...
            case 'ring_pulse':
                ...
                break;
            case 'ring_rotate':
                $svg_ring_circle_color = !empty($settings['anim_color']) ? 'rgba('.\Medify_Theme_Helper::HexToRGB($settings['anim_color']).', 0.1)' : 'rgba(0,0,0,0.1)';
