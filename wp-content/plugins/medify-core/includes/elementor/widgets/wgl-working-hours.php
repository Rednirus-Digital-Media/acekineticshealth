...
class Wgl_Working_Hours extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Wgl Working Hours', 'medify-core' );
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            ...
            array(
                ...
                'default' => esc_html__('Monday', 'medify-core'),
                'dynamic' => ['active' => true],
            )
        );
        ...
        $repeater->add_control(
            ...
            array(
                ...
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('8.00 - 21.00', 'medify-core'),
            )
        );
        ...
        $repeater->add_control(
            'custom_colors',
            array(
                'label'        => esc_html__('Custom Colors','medify-core' ),
        ...
        $repeater->add_control(
            'day_color',
            array(
                'label' => esc_html__( 'Day Color', 'medify-core' ),
        ...
        $repeater->add_control(
            'hours_color',
            array(
                'label' => esc_html__( 'Hours Color', 'medify-core' ),
                'type' => Controls_Manager::COLOR,
        ...
        $this->add_control(
            'items',
            array(
                'label'   => esc_html__( 'Days', 'medify-core' ),
                'type'    => Controls_Manager::REPEATER,
                'default' => [
                    ['working_day' => esc_html__('Monday', 'medify-core')],
                    ['working_day' => esc_html__('Tuesday', 'medify-core')],
                ],
        ...
        $this->start_controls_section(
            'style_section',
            array(
                'label'     => esc_html__( 'Styles', 'medify-core' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'label'   => esc_html__( 'Item Styles', 'medify-core' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label'   => esc_html__( 'Day Styles', 'medify-core' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label'   => esc_html__( 'Hours Styles', 'medify-core' ),
            ]
        );
        ...
        $this->add_control(
            'line_color',
            array(
                'label' => esc_html__( 'Line Between Color', 'medify-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#e5e5e5',
                'selectors' => array(
