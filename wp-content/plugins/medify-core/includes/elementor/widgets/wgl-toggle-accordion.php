...
class Wgl_Toggle_Accordion extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Wgl Toggle/Accordion', 'medify-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section('wgl_accordion_section',
            array(
                'label'         => esc_html__('General', 'medify-core'),
            )
        );

        $this->add_control('acc_type',
            array(
                'label'             => esc_html__('Type', 'medify-core'),
                'type'              => Controls_Manager::SELECT,
                'default' => 'accordion',
                'options' => [
                    'accordion' => esc_html__('Accordion', 'medify-core'),
                    'toggle' => esc_html__('Toggle', 'medify-core'),
                ],
            )
        );
        ...
        $this->add_control('enable_acc_icon',
            array(
                ...
                'options' => [
                    ...
                    'def' => esc_html__('Default', 'medify-core'),
        ...
        $this->add_control('acc_icon',
            array(
                'label'             => esc_html__('Toggle Icon', 'medify-core'),
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Tab Panel Margin', 'medify-core' ),
				'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', 'em', '%' ],
                'default' => [
                    'top' => 0,
        ...
        $repeater->add_control(
			'acc_tab_title',
			[
                'label' => esc_html__('Tab Title', 'medify-core'),
                'type' => Controls_Manager::TEXTAREA,
                'default' => esc_html__('Tab Title', 'medify-core'),
                'dynamic' => ['active' => true],
			]
        );
        $repeater->add_control(
			'acc_tab_def_active',
			[
                'label' => esc_html__('Active as Default', 'medify-core'),
        ...
        $repeater->add_control(
			'acc_content_type',
			[
                'label' => esc_html__('Content Type', 'medify-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'content' => esc_html__('Content', 'medify-core'),
                    'template' => esc_html__('Saved Templates', 'medify-core'),
                ],
                'default' => 'content',
			]
        );
        $repeater->add_control(
			...
			[
                'label' => esc_html__('Choose Template', 'medify-core'),
                'type' => Controls_Manager::SELECT,
        ...
        $repeater->add_control(
			'acc_content',
			[
                'label' => esc_html__('Tab Content', 'medify-core'),
                'type' => Controls_Manager::WYSIWYG,
                'default' => esc_html__('Lorem ipsum dolor sit amet, consectetur adipisicing elit. Optio, neque qui velit. Magni dolorum quidem ipsam eligendi, totam, facilis laudantium cum accusamus ullam voluptatibus commodi numquam, error, est. Ea, consequatur.', 'medify-core'),
                'dynamic' => ['active' => true],
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'seperator' => 'before',
                'default' => [
                    ['acc_tab_title' => esc_html__('Tab Title 1', 'medify-core'),
                    'acc_tab_def_active' => 'yes'],
                    ['acc_tab_title' => esc_html__('Tab Title 2', 'medify-core')],
                    ['acc_tab_title' => esc_html__('Tab Title 3', 'medify-core')],
                ],
        ...
        $this->add_control(
			'acc_title_tag',
			[
				'label' => esc_html__( 'Title HTML Tag', 'medify-core' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'h1' => 'H1',
					'h2' => 'H2',
        ...
        /* Normal */
        $this->start_controls_tab('acc_header_normal', ['label' => esc_html__('Normal', 'medify-core')]);
        ...
        $this->add_control(
            'acc_title_bg_color',
            array(
                'label' => esc_html__( 'Title Background Color', 'medify-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => array(
        ...
        /* End Normal Tab */
        /* Hover */
        $this->start_controls_tab('acc_header_hover', ['label' => esc_html__('Hover', 'medify-core')]);
        ...
        /* End Hover Tab */
        /* Active */
        $this->start_controls_tab('acc_header_active', ['label' => esc_html__('Active', 'medify-core')]);
        ...
        /* Normal */
        $this->start_controls_tab('acc_icon_normal', ['label' => esc_html__('Normal', 'medify-core')]);
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => $theme_color,
                'selectors' => array(
                    '{{WRAPPER}} .wgl-accordion_icon:before,{{WRAPPER}} .wgl-accordion_icon:after' => 'background-color: {{VALUE}};',
                ),
            )
        );
        ...
        $this->add_control(
            'acc_icon_bg_color',
            array(
                'label' => esc_html__( 'Icon Background Color', 'medify-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => array(
        ...
        /* End Normal Tab */
        /* Hover */
        $this->start_controls_tab('acc_icon_hover', ['label' => esc_html__('Hover', 'medify-core')]);
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => $header_font_color,
                'selectors' => array(
                    '{{WRAPPER}} .wgl-accordion_header:hover .wgl-accordion_icon:before, {{WRAPPER}} .wgl-accordion_header:hover .wgl-accordion_icon:after' => 'background-color: {{VALUE}};',
                ),
            )
        );
        ...
        /* End Hover Tab */
        /* Active */
        $this->start_controls_tab('acc_icon_active', ['label' => esc_html__('Active', 'medify-core')]);
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => '#ffffff',
                'selectors' => array(
                    '{{WRAPPER}} .wgl-accordion_header.active .wgl-accordion_icon:before, {{WRAPPER}} .wgl-accordion_header.active .wgl-accordion_icon:after' => 'background-color: {{VALUE}};',
                ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Content Background Color', 'medify-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => array(
            ...
            foreach ( $settings['acc_tab'] as $index => $item ) :
                ...
                <div class="wgl-accordion_panel">
                    <<?php echo $settings['acc_title_tag']; ?> <?php echo $this->get_render_attribute_string( $tab_title_key ); ?>>
                        <span class="wgl-accordion_title"><?php echo $item['acc_tab_title'] ?></span>
