...
class Wgl_Progress_Bar extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Wgl Progress Bar', 'medify-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section('wgl_progress_bar_section',
            array(
                'label'         => esc_html__('Progress Bar Settings', 'medify-core'),
            )
        );
        ...
        $this->add_control('progress_title',
            array(
				...
				'default' => esc_html__( 'My Skill', 'medify-core' ),
				'label_block' => true,
            )
        );
		...
		$this->add_control(
			'value',
			[
				'label' => esc_html__( 'Value', 'medify-core' ),
        ...
        $this->add_control('units',
            array(
                'label'             => esc_html__('Units', 'medify-core'),
                'type'              => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				'placeholder' => esc_html__( 'Enter your units', 'medify-core' ),
				'description' => esc_html__( 'Enter measurement units (Example: %, px, points, etc.)', 'medify-core' ),
        ...
        $this->add_control(
			'value_pos',
			[
				'label' => esc_html__( 'Value Position', 'medify-core' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'fixed' => esc_html__('Fixed', 'medify-core' ),
					'dynamic' => esc_html__('Dynamic', 'medify-core' ),
				],
				'default' => 'dynamic',
			]
        );
        ...
        $this->start_controls_section(
            'bar_style_section',
            array(
                'label'     => esc_html__( 'Progress Bar', 'medify-core' ),
                'tab'       => Controls_Manager::TAB_STYLE,
            )
        );
		...
		$this->add_control(
			'bar_height',
			[
				'label' => esc_html__( 'Progress Bar Height', 'medify-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 1,
        ...
        $this->add_control(
            'bar_bg_color',
            array(
                'label' => esc_html__( 'Background Bar Color', 'medify-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#f6f7fa',
                'selectors' => array(
        ...
        $this->add_control(
            'bar_color',
            array(
                'label' => esc_html__( 'Bar Color', 'medify-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => esc_attr($theme_color),
                'selectors' => array(
