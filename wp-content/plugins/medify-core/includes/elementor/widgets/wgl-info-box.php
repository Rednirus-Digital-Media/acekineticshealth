...
class Wgl_Info_Box extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Wgl Info Box', 'medify-core' );
    }
    ...
    protected function register_controls() {
        ...
        $output = array();
        $output['view'] = array(
            'label' => esc_html__( 'View', 'medify-core' ),
            'type' => Controls_Manager::SELECT,
            'options' => [
                'default' => esc_html__( 'Default', 'medify-core' ),
                'stacked' => esc_html__( 'Stacked', 'medify-core' ),
                'framed' => esc_html__( 'Framed', 'medify-core' ),
            ],
            'default' => 'default',
        ...
        $output['shape'] = array(
            'label' => esc_html__( 'Shape', 'medify-core' ),
            'type' => Controls_Manager::SELECT,
            'options' => [
                'circle' => esc_html__( 'Circle', 'medify-core' ),
                'square' => esc_html__( 'Square', 'medify-core' ),
            ],
            'default' => 'circle',
            'condition'     => [
                'icon_type'  => 'font',
        ...
        Wgl_Icons::init( $this, array( 'label' => esc_html__('Info Box ', 'medify-core'), 'output' => $output,'section' => true, 'prefix' => '' ) );
        ...
        $this->start_controls_section('wgl_ib_content',
            array(
                'label'         => esc_html__('Info Box Content', 'medify-core'),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label'        => esc_html__('Add Background Title','medify-core' ),
        ...
        $this->add_control('ib_bg_title',
            array(
                'label'         => esc_html__('Background Title', 'medify-core'),
                'type'          => Controls_Manager::TEXT,
                'label_block'   => true,
                'default'       => esc_html__('This is the heading​', 'medify-core'),
                'dynamic'       => [ 'active' => true ],
        ...
        $this->add_control('ib_content',
            array(
                'label'             => esc_html__('Info Box Text', 'medify-core'),
                'type'    => Controls_Manager::WYSIWYG,
				'dynamic' => [
					'active' => true,
				],
				'placeholder' => esc_html__( 'Description Text', 'medify-core' ),
				'label_block' => true,
                'default'       => esc_html__('Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'medify-core'),
            )
        );
        ...
        $this->start_controls_section(
            'section_style_link',
            [
                'label' => esc_html__( 'Infobox Link', 'medify-core' ),
            ]
        );

        $this->add_control('add_item_link',
            array(
                'label'        => esc_html__('Add Link To Whole Item','medify-core' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'On', 'medify-core' ),
                'label_off'    => esc_html__( 'Off', 'medify-core' ),
                'return_value' => 'yes',
        ...
        $this->add_control('add_read_more',
            array(
                'label'             => esc_html__('Add \'Read More\' Button', 'medify-core'),
                'type'              => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'On', 'medify-core' ),
                'label_off'    => esc_html__( 'Off', 'medify-core' ),
                'return_value' => 'yes',
        ...
        $this->add_control('link',
            array(
                'label'             => esc_html__('Button Link', 'medify-core'),
                'type'              => Controls_Manager::URL,
                'dynamic' => [
                    'active' => true,
                ],
        ...
        $this->add_control(
            ...
            array(
                'label'        => esc_html__('Stick the button','medify-core' ),

                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'On', 'medify-core' ),
                'label_off'    => esc_html__( 'Off', 'medify-core' ),
                'return_value' => 'yes',
                'description' => esc_html__( 'Attach to the bottom right or left corner.', 'medify' ),
                'condition'     => [
                    'add_read_more'   => 'yes',
                ],
            )
        ...
        $this->add_control('read_more_icon_sticky_pos',
            array(
                'label'             => esc_html__('Read More Position', 'medify-core'),
                'type'              => Controls_Manager::SELECT,
                'options'           => [
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Icon Position', 'medify-core' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'right',
                'options' => [
                    'left' => esc_html__( 'Before', 'medify-core' ),
                    'right' => esc_html__( 'After', 'medify-core' ),
                ],
                'condition'     => [
                    'add_read_more'   => 'yes',
                ],
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Icon Spacing', 'medify-core' ),
        ...
        $this->add_control(
            'primary_color',
            [
                'label' => esc_html__( 'Primary Color', 'medify-core' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Hover Animation', 'medify-core' ),
        ...
        $this->add_responsive_control(
            'icon_size',
            [
                'label' => esc_html__( 'Size', 'medify-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 6,
        ...
        $this->add_control(
            'rotate',
            [
                'label' => esc_html__( 'Rotate', 'medify-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 0,
                    'unit' => 'deg',
        ...
        $this->add_control(
            'border_width',
            [
                'label' => esc_html__( 'Border Width', 'medify-core' ),
                'type' => Controls_Manager::DIMENSIONS,
                'selectors' => [
        ...
        $this->add_responsive_control(
            'image_size',
            [
                'label' => esc_html__( 'Width', 'medify-core' ) . ' (%)',
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 100,
                    'unit' => '%',
        ...
        $this->add_control(
            'image_opacity',
            [
                'label' => esc_html__( 'Opacity', 'medify-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 1,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Transition Duration', 'medify-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 0.3,
                ],
        ...
        $this->add_control('title_tag',
            array(
                ...
                'type'          => Controls_Manager::SELECT,
                'default'       => 'h3',
                'description'   => esc_html__( 'Choose your tag for info box title', 'medify-core' ),
                'options'       => [
                    'h1'      => 'H1',
                    'h2'      => 'H2',
                    'h3'      => 'H3',
        ...
        $this->add_responsive_control(
            'title_offset',
            array(
                'label' => esc_html__( 'Title Offset', 'medify-core' ),
                'type' => Controls_Manager::DIMENSIONS,
                'default'   => [
                    'top' => '',
                    'right' => '',
        ...
        $this->add_control('content_tag',
            array(
                'label'         => esc_html__('Content Tag', 'medify-core'),
                'type'          => Controls_Manager::SELECT,
                'default'       => 'div',
                'description'   => esc_html__( 'Choose your tag for info box content', 'medify-core' ),
                'options'       => [
                    'h1'      => 'H1',
                    'h2'      => 'H2',
                    'h3'      => 'H3',
        ...
        $this->add_responsive_control(
            'content_offset',
            array(
                'label' => esc_html__( 'Content Offset', 'medify-core' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', 'em', '%' ],
                'default'       => [
                    'top'   => 0,
        ...
        $this->start_controls_section(
            ...
            array(
                'label'     => esc_html__( 'Button', 'medify-core' ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition'     => [
                    'add_read_more!'   => '',
                ],
