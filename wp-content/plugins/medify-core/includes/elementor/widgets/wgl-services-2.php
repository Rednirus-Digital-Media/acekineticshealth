...
class Wgl_Services_2 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Wgl Services 2', 'medify-core' );
    }
    ...
    protected function register_controls() {
        ...
        $output['media_width'] = array(
            'label' => esc_html__( 'Media Width(Height)', 'medify-core' ),
            'type' => Controls_Manager::NUMBER,
            'min' => 50,
            'step' => 1,
            'default' => 110,
            'description' => esc_html__( 'Enter value in pixels', 'medify-core' ),
            'condition'         => [
                'icon_type!'   => '',
            ],
            'separator' => 'before',
        ...
        Wgl_Icons::init( $this, array( 'label' => esc_html__('Services 2 ', 'medify-core'), 'output' => $output,'section' => true, 'prefix' => '' ) );
        ...
        $this->add_control('ib_content',
            array(
                'label'             => esc_html__('Service Text', 'medify-core'),
        ...
        $this->add_control(
            'border_type',
            [
                'label' => esc_html__( 'Border Type', 'Border Control', 'medify-core' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'solid' => esc_html__( 'Solid', 'Border Control', 'medify-core' ),
                    'double' => esc_html__( 'Double', 'Border Control', 'medify-core' ),
                    'dotted' => esc_html__( 'Dotted', 'Border Control', 'medify-core' ),
                    'dashed' => esc_html__( 'Dashed', 'Border Control', 'medify-core' ),
                    'groove' => esc_html__( 'Groove', 'Border Control', 'medify-core' ),
                ],
                'default' => 'dashed',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Border Color', 'medify-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => $second_color,
                'selectors' => [
        ...
        $this->add_control(
            'circle_width',
            [
                'label' => esc_html__( 'Circles Width(Height)', 'medify-core' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 2,
                'step' => 1,
                'default' => 8,
        ...
        $this->add_control(
            'circle_color_1',
            [
                'label' => esc_html__( 'First Circle Color', 'medify-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => $second_color,
                'selectors' => [
        ...
        $this->add_control(
            'circle_color_2',
            [
                'label' => esc_html__( 'Second Circle Color', 'medify-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => $second_color,
                'selectors' => [
        ...
        $this->add_control('title_tag',
            array(
                ...
                'type'          => Controls_Manager::SELECT,
                'default'       => 'h3',
                'description'   => esc_html__( 'Choose your tag for service title', 'medify-core' ),
                'options'       => [
                    'h1'      => 'H1',
                    'h2'      => 'H2',
                    'h3'      => 'H3',
        ...
        $this->add_control('content_tag',
            array(
                ...
                'type'          => Controls_Manager::SELECT,
                'default'       => 'div',
                'description'   => esc_html__( 'Choose your tag for service content', 'medify-core' ),
                'options'       => [
                    'h1'      => 'H1',
                    'h2'      => 'H2',
                    'h3'      => 'H3',
        ...
        $this->start_controls_section(
            ...
            array(
                'label'     => esc_html__( 'Item', 'medify-core' ),
                'tab'       => Controls_Manager::TAB_STYLE,
            )
        );
    ...
    public function render(){
        ...
        if (isset($settings['link']['url'])) $this->add_link_attributes('serv_link', $settings['link']);
