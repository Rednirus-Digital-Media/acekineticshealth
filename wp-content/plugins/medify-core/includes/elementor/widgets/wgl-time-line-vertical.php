...
class Wgl_Time_Line_Vertical extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Wgl Time Line Vertical', 'medify-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control('start_image',
            array(
                'label'         => esc_html__('Time Line Start Image', 'medify-core'),
        ...
        $this->add_responsive_control(
            'start_image_margin',
            array(
                'label' => esc_html__( 'Image Margin', 'medify-core' ),
        ...
        $this->add_control(
            'line_color',
            array(
                'label' => esc_html__( 'Line Color', 'medify-core' ),
        ...
        $this->start_controls_section('content_section',
            array(
                'label'         => esc_html__('Content Settings', 'medify-core'),
            )
        );
        ...
        $repeater->add_control(
            'date',
            array(
                'label'             => esc_html__('Date', 'medify-core'),
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => [
                    ['title' => esc_html__('This is the heading​', 'medify-core')],
                    ['title' => esc_html__('This is the heading​', 'medify-core')],
                ],
                'title_field' => '{{title}}',
            )
    ...
    protected function render() {
        ...
        $image = $settings['start_image_thumb']['url'] ?? '';
