...
class Wgl_Flipbox extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Wgl Flipbox', 'medify-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Flipbox Settings', 'medify-core' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'flip_right' => esc_html__( 'Flip to Right', 'medify-core' ),
                    'flip_left' => esc_html__( 'Flip to Left', 'medify-core' ),
                    'flip_top' => esc_html__( 'Flip to Top', 'medify-core' ),
                    'flip_bottom' => esc_html__( 'Flip to Bottom', 'medify-core' ),
                ],
                'default' => 'flip_right',
            ]
        );
        ...
        $this->add_control(
            'flipbox_height',
            array(
                'label' => esc_html__( 'Custom Flipbox Height)', 'medify-core' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Flipbox Icon', 'medify-core' ),
            ]
        );
        ...
        $this->start_controls_tab(
            'flipbox_front_icon',
            [
                'label' => esc_html__( 'Front', 'medify-core' ),
            ]
        );

        Wgl_Icons::init( $this, array( 'label' => esc_html__('Flipbox ', 'medify-core'), 'output' => '', 'section' => false, 'prefix' => 'front_') );
        ...
        $this->start_controls_tab(
            'flipbox_back_icon',
            [
                'label' => esc_html__( 'Back', 'medify-core' ),
            ]
        );

        Wgl_Icons::init( $this, array( 'label' => esc_html__('Flipbox ', 'medify-core'), 'output' => '', 'section' => false,'prefix' => 'back_') );
        ...
        $this->start_controls_section('wgl_ib_content',
            array(
                'label'         => esc_html__('Flipbox Content', 'medify-core'),
            )
        );
        ...
        $this->add_control('front_content',
            array(
                'label'             => esc_html__('Flipbox Text', 'medify-core'),
        ...
        $this->start_controls_section(
            'section_style_link',
            [
                'label' => esc_html__( 'Flipbox Link', 'medify-core' ),
            ]
        );
        ...
        $this->start_controls_section(
            'section_style',
            [
                'label' => esc_html__( 'Flipbox Styles', 'medify-core' ),
        ...
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Front Background', 'medify-core' ),
        ...
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Back Background', 'medify-core' ),
				'types' => [ 'classic', 'gradient' ],
        ...
        $this->add_control('title_tag',
            array(
                ...
                'type'          => Controls_Manager::SELECT,
                'default'       => 'h3',
                'description'   => esc_html__( 'Choose your tag for flipbox title', 'medify-core' ),
                'options'       => [
                    'h1'      => 'H1',
                    'h2'      => 'H2',
                    'h3'      => 'H3',
    ...
    public function render(){
        ...
        if (isset($settings['link']['url'])) $this->add_link_attributes('flipbox_link', $settings['link']);
