...
class Wgl_Striped_Services extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Wgl Striped Services', 'medify-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            'interval',
            array(
                'label' => esc_html__( 'Services Height', 'medify-core' ),
        ...
        $repeater->add_control(
            ...
            array(
                ...
                'default' => esc_html__('Service Title', 'medify-core'),
                'dynamic' => ['active' => true],
            )
        );
        ...
        $repeater->add_control(
            ...
            array(
                ...
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Service Subtitle', 'medify-core'),
            )
        );
        ...
        $repeater->add_responsive_control(
            'bg_position',
            array(
                'label' => esc_html__( 'Position', 'Background Control', 'medify-core' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'top left',
                'responsive' => true,
                'options' => [
                    'top left' => esc_html__( 'Top Left', 'Background Control', 'medify-core' ),
                    'top center' => esc_html__( 'Top Center', 'Background Control', 'medify-core' ),
                    'top right' => esc_html__( 'Top Right', 'Background Control', 'medify-core' ),
                    'center left' => esc_html__( 'Center Left', 'Background Control', 'medify-core' ),
                    'center center' => esc_html__( 'Center Center', 'Background Control', 'medify-core' ),
                    'center right' => esc_html__( 'Center Right', 'Background Control', 'medify-core' ),
                    'bottom left' => esc_html__( 'Bottom Left', 'Background Control', 'medify-core' ),
                    'bottom center' => esc_html__( 'Bottom Center', 'Background Control', 'medify-core' ),
                    'bottom right' => esc_html__( 'Bottom Right', 'Background Control', 'medify-core' ),
        ...
        $repeater->add_control(
            'bg_size',
            array(
                'label' => esc_html__( 'Size', 'Background Control', 'medify-core' ),
                'type' => Controls_Manager::SELECT,
                'responsive' => true,
                'default' => 'cover',
                'options' => [
                    'auto' => esc_html__( 'Auto', 'Background Control', 'medify-core' ),
                    'cover' => esc_html__( 'Cover', 'Background Control', 'medify-core' ),
                    'contain' => esc_html__( 'Contain', 'Background Control', 'medify-core' ),
                ],
                'condition' => [
                    'thumbnail[url]!' => '',
                ],
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => [
                    ['serv_title' => esc_html__('Service Title', 'medify-core')],
                ],
                'fields'      => $repeater->get_controls(),
                'title_field' => '{{serv_title}}',
                'description' => esc_html__( 'Enter services height in pixels', 'medify-core' ),
            )
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'label'   => esc_html__( 'Add less than 4 items for proper rendering', 'medify-core' ),
            ]
        );
        ...
        $this->add_control(
			'subtitle_tag',
			[
				'label' => esc_html__( 'Subtitle HTML Tag', 'medify-core' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'h1' => 'H1',
					'h2' => 'H2',
    ...
    protected function render() {
        ...
        foreach ( $settings['items'] as $index => $item ) {
            ...
            $this->add_render_attribute($serv_link, 'class', 'service-item_link');
            if (isset($item['serv_link']['url'])) $this->add_link_attributes($serv_link, $item['serv_link']);
