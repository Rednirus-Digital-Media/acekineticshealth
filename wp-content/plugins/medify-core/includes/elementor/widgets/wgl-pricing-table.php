...
class Wgl_Pricing_Table extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Wgl Pricing Table', 'medify-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section('wgl_pricing_table_section',
            array(
                'label'         => esc_html__('Pricing Table Settings', 'medify-core'),
            )
        );
        ...
        $this->add_control('pricing_title',
            array(
				...
				'default' => esc_html__( 'Basic', 'medify-core' ),
				'label_block' => true,
            )
        );
        ...
        $this->add_control('pricing_cur',
            array(
                'label'             => esc_html__('Currency', 'medify-core'),
                'type'              => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				'placeholder' => esc_html__( 'Enter your currency', 'medify-core' ),
				'default' => esc_html__( '$', 'medify-core' ),
				'label_block' => true,
            )
        );
        ...
        $this->add_control('pricing_price',
            array(
                'label'             => esc_html__('Price', 'medify-core'),
                'type'              => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				'placeholder' => esc_html__( 'Enter your price', 'medify-core' ),
				'default' => esc_html__( '99', 'medify-core' ),
				'label_block' => true,
            )
        );
        ...
        $this->add_control('pricing_quantity',
            array(
                'label'             => esc_html__('Quantity unit', 'medify-core'),
                'type'              => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				'placeholder' => esc_html__( 'Enter your quantity', 'medify-core' ),
				'default' => esc_html__( '/ month', 'medify-core' ),
				'label_block' => true,
            )
        );
        ...
        $this->add_control('pricing_desc',
            array(
                'label'             => esc_html__('Description', 'medify-core'),
                'type'              => Controls_Manager::TEXTAREA,
				'dynamic' => [
					'active' => true,
				],
				'placeholder' => esc_html__( 'Enter your description', 'medify-core' ),
				'label_block' => true,
            )
        );
        ...
        $this->start_controls_section('wgl_pricing_table_button',
            array(
                'label'         => esc_html__('Pricing Table Button', 'medify-core'),
            )
        );
        ...
        $this->add_control('button_title',
            array(
				...
				'default' => esc_html__( 'Choose Plan', 'medify-core' ),
				'label_block' => true,
            )
        );
