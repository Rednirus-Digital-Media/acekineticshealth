...
class Wgl_Tabs extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Wgl Tabs', 'medify-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control('tabs_tab_align',
			[
				...
				'options' => [
					...
					'justify' => [
						'title' => esc_html__( 'Justified', 'medify-core' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'seperator' => 'before',
                'default' => [
                    ['tabs_tab_title' => esc_html__('Tab Title 1', 'medify-core')],
                    ['tabs_tab_title' => esc_html__('Tab Title 2', 'medify-core')],
                    ['tabs_tab_title' => esc_html__('Tab Title 3', 'medify-core')],
                ],
        ...
        $this->add_responsive_control(
			'tabs_title_line',
			[
                'label' => esc_html__('Add Title Bottom Line', 'medify-core'),
        ...
        /* Normal */
        $this->start_controls_tab('tabs_header_normal', ['label' => esc_html__('Normal', 'medify-core')]);
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Title Bottom Line Color', 'medify-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => array(
        ...
        /* End Normal Tab */
        /* Hover */
        $this->start_controls_tab('tabs_header_hover', ['label' => esc_html__('Hover', 'medify-core')]);
        ...
        /* End Hover Tab */
        /* Active */
        $this->start_controls_tab('tabs_header_active', ['label' => esc_html__('Active', 'medify-core')]);
        ...
        $this->add_control('tabs_icon_position',
            array(
                'label'             => esc_html__('Icon/Image Position', 'medify-core'),
                'type'              => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options'           => [
                    'top'              => [
        ...
        /* Normal */
        $this->start_controls_tab('tabs_icon_normal', ['label' => esc_html__('Normal', 'medify-core')]);
        ...
        /* End Normal Tab */
        /* Hover */
        $this->start_controls_tab('tabs_icon_hover', ['label' => esc_html__('Hover', 'medify-core')]);
        ...
        /* End Hover Tab */
        /* Active */
        $this->start_controls_tab('tabs_icon_active', ['label' => esc_html__('Active', 'medify-core')]);
