...
class WGL_Posts_Hero extends WP_Widget {
    ...
    function __construct() {
        /* Widget settings. */
        $widget_ops = array('description' => esc_html__( 'Display posts with overlay image' , 'medify-core' ) );

        /* Create the widget. */
        parent::__construct( 'postshero', esc_html__( 'WGL Posts Hero', 'medify-core' ), $widget_ops );
    }
                    ...
                    <div class="recent-posts-content">
                        <?php
                            if(!empty($img_render)){
                                echo '<div class="recent-posts-image_wrapper">';
                                    $single = Medify_SinglePost::getInstance();
                                    $link_feature = true;
                        ...
                        <div class="recent-posts-content_wrapper">
                            ...
                            <?php if ( ( $show_cats == 'true' ) ) : ?>
                                <div class="post_cat">                         
                                    <?php
                                        echo Medify_Theme_Helper::render_html($render_cats); 
                                    ?>                                 
                                </div> <!-- /entry-widget-date -->  
                            <?php endif; ?>
                        </div>
    ...
    function form($instance)
    {
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_id('show_cats')); ?>"><?php esc_html_e( 'Show categories' , 'medify-core' ); ?></label>
        </p>        
        <p>
